...
# from tqdm import tqdm  # If you're running this outside of Colab, remove .notebook
...
# def run_change_detection(s1_t1_path, s1_t2_path, s2_t1_path, s2_t2_path, output_path, model_path, tile_size=256):
#     device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
#     net = load_checkpoint("mmcr_train100", device, model_path)  # Assuming model is "mmcr_train100"
...
#         logits_ch, logits_sem_t1 = logits[0], logits[5]
...
#     return output_path #added return so the flask app has the file path.