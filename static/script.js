...
// Add the ESRI satellite basemap (this is the background)
...
// Create the layer control to toggle between the satellite and OpenStreetMap layers
var baseMaps = {
    "Satellite": esriLayer,
    "OpenStreetMap": osmLayer
};

// Add the layer control to the map (this allows toggling between the two layers)
